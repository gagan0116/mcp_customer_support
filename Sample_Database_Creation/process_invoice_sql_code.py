...
# ----------------------------
# Gemini extraction schema (internal only)
# ----------------------------
...
def gemini_extract(invoice_text: str, model: str, api_key: str) -> Dict[str, Any]:
...
def main() -> None:
    ...
    extracted = gemini_extract(text, model=args.model, api_key=api_key)
